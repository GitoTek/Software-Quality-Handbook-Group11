...
* [Tasks estimation in SCRUM](/readme-content/tasks-estimation.md)
    * [The different estimation methods](#the-different-estimation-methods---why-do-we-prefer-fibonacci)
        * [The Bucket System Estimation](#the-bucket-system-estimation)
        * [Three-Point Method](#three-point-method)
        * [Planning poker/Fibonacci](#planning-poker-with-the-fibonacci-sequence)
